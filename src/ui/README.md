...
| File | What |
|---|---|
| `InputController.ts` | Every mouse/trackpad/keyboard binding (documented in `docs/CONTROLS.md`). Drag modes: rotate / pan / paint / box (two-phase: footprint drag, then pointer sets height until the next click). |
